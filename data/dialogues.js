    ...
    scenarios: [
      {
        ...
        turns: [
          turn('turn-1', 'A', 'Where are you from?', '你来自哪里？', '询问对方来自哪里。', 'p1-where-from', ['questions.1']),
      ...
      },
      {
        ...
        turns: [
          turn('turn-1', 'A', 'Are you cold?', '你冷吗？', '询问对方是否觉得冷。', 'p1-are-you-adjective', ['grammar.1.patterns.1']),
      ...
      },
      {
        ...
        goalCn: '确认物品，并询问它的颜色。',
        turns: [
          turn('turn-1', 'A', 'Where is my phone?', '我的手机在哪里？', '询问自己的手机在哪里。', 'p1-where-is-item', ['translations.3.en']),
    ...
    scenarios: [
      {
        ...
        goalCn: '谈论早餐和饮料习惯。',
        turns: [
          turn('turn-1', 'A', 'What do you have for breakfast?', '你早餐吃什么？', '询问对方早餐吃什么。', 'p2-what-have-breakfast', ['questions.1']),
      ...
      },
      {
        ...
        goalCn: '询问起床和开始工作的时间。',
        turns: [
          turn('turn-1', 'A', 'What time do you get up?', '你几点起床？', '询问对方的起床时间。', 'p2-what-time-do', ['sentences.3']),
      ...
      },
      {
        ...
        goalCn: '谈论居住地点和工作地点。',
        turns: [
          turn('turn-1', 'A', 'Where do you live?', '你住在哪里？', '询问对方住在哪里。', 'p2-where-do-live', ['grammar.0.patterns.2']),
    ...
    scenarios: [
      {
        ...
        turns: [
          turn('turn-1', 'A', 'Can you swim?', '你会游泳吗？', '询问对方会不会游泳。', 'p3-can-you-verb', ['questions.0']),
      ...
      },
      {
        ...
        goalCn: '礼貌请求帮助和借用物品。',
        turns: [
          turn('turn-1', 'A', 'Can you help me?', '你能帮我吗？', '请求对方帮助自己。', 'p3-can-you-help', ['grammar.1.patterns.0']),
      ...
      },
      {
        ...
        goalCn: '请求坐下或停车的许可。',
        turns: [
          turn('turn-1', 'A', 'Excuse me, can I sit here?', '打扰一下，我可以坐在这里吗？', '礼貌询问是否可以坐下。', 'p3-can-i-sit', ['sentences.2']),
    ...
    scenarios: [
      {
        ...
        goalCn: '询问并描述昨晚的状态。',
        turns: [
          turn('turn-1', 'A', 'Where were you last night?', '你昨晚在哪里？', '询问对方昨晚在哪里。', 'p4-where-were-you', ['questions.0']),
      ...
      },
      {
        ...
        goalCn: '谈论昨天的天气和所在地点。',
        turns: [
          turn('turn-1', 'A', 'How was your day yesterday?', '你昨天过得怎么样？', '询问对方昨天过得如何。', 'p4-how-was-day', ['questions.1']),
      ...
      },
      {
        ...
        turns: [
          turn('turn-1', 'A', 'What do you like doing in your free time?', '你空闲时间喜欢做什么？', '询问对方空闲时间喜欢做什么。', 'p4-like-doing', ['questions.2']),
    ...
    scenarios: [
      {
        ...
        turns: [
          turn('turn-1', 'A', 'Where did you go last weekend?', '你上周末去了哪里？', '询问对方上周末去了哪里。', 'p5-where-did-go', ['questions.2']),
      ...
      },
      {
        ...
        goalCn: '询问并描述过去的旅行地点。',
        turns: [
          turn('turn-1', 'A', 'Did you go to Greece last year?', '你去年去希腊了吗？', '询问对方去年是否去了希腊。', 'p5-did-you-go', ['sentences.1']),
      ...
      },
      {
        ...
        goalCn: '询问并描述昨天做过的事情。',
        turns: [
          turn('turn-1', 'A', 'What did you do yesterday?', '你昨天做了什么？', '询问对方昨天做了什么。', 'p5-what-did-do', ['translations.0.en']),
    ...
    scenarios: [
      {
        ...
        turns: [
          turn('turn-1', 'A', 'Is there a lift?', '这里有电梯吗？', '询问这里有没有电梯。', 'p6-is-there-item', ['grammar.1.patterns.0']),
      ...
      },
      {
        ...
        goalCn: '询问冰箱和衣柜里的物品。',
        turns: [
          turn('turn-1', 'A', 'Are there any eggs in our fridge?', '我们的冰箱里有鸡蛋吗？', '询问冰箱里有没有鸡蛋。', 'p6-are-there-items', ['sentences.3']),
      ...
      },
      {
        ...
        goalCn: '谈论过去在车站发生的见面。',
        turns: [
          turn('turn-1', 'A', 'Where did the man first see Olivia?', '那个男人最初在哪里见到奥利维亚？', '询问男人最初在哪里见到奥利维亚。', 'p6-where-did-see', ['questions.3']),
